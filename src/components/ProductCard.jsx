    ...
    <div className="bg-white border border-border rounded-xl shadow-sm p-4">
      ...
      <div className="flex justify-between items-center mt-3">
        <button
          ...
          className="text-sm bg-green-100 px-2 py-1 rounded-md hover:bg-green-600 hover:text-white transition"
        >
          Buy
        </button>
        ...
        <Link
          ...
          className="text-sm bg-soft px-2 py-1 rounded-md hover:bg-brand hover:text-white transition"
        >
          View
        </Link>
        ...
        <Link
          ...
          className="bg-blue-100 text-sm px-2 py-1 rounded-md hover:bg-blue-500 hover:text-white transition"
        >
          Edit
        </Link>
        ...
        <button
          ...
          className="text-sm bg-red-100 px-2 py-1 rounded-md hover:bg-red-500 hover:text-white transition"
        >
          Delete
        </button>
      </div>
